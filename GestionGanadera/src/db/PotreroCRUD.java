...
public class PotreroCRUD {
	...
	public static void delete(String nombre) {
		...
		try {
			...
			sql.getStatement().executeUpdate(
					"DELETE FROM res_tiene_pesos WHERE resID IN(SELECT numero FROM res WHERE potreroNombre= '" + nombre
							+ "')");
			sql.getStatement().executeUpdate(
					"DELETE FROM res_tiene_purgantes WHERE resID IN(SELECT numero FROM res WHERE potreroNombre= '"
							+ nombre + "')");
			sql.getStatement().executeUpdate(
					"DELETE FROM res_tiene_vacunas WHERE resID IN(SELECT numero FROM res WHERE potreroNombre= '"
							+ nombre + "')");
