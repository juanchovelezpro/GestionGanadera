...
public class SQLConnection {
	...
	public void createDatabase() {
		...
		try {
			...
			statement.executeUpdate("CREATE TABLE \"vitaminas\" ( \"nombre\" TEXT NOT NULL, PRIMARY KEY(\"nombre\") )");
			statement.executeUpdate(
			...
			statement.executeUpdate(
					"CREATE TABLE \"res_tiene_vitaminas\" ( \"id\" INTEGER UNIQUE, \"resID\" TEXT, \"vitaminaNombre\" TEXT, \"fecha\" TEXT, PRIMARY KEY(\"id\" AUTOINCREMENT) )");
